...
def forgotpass():
    ...
    def newPass():
        ...
        if randomPIN == pinInfo:
            ...
            changepassEntry1 = tk.Entry(changepassPAN)
            changepassEntry2 = tk.Entry(changepassPAN)
    ...
    def sendEmail():
        ...
        if results:
            gmail_user = "MrSaintJCode@gmail.com"
            gmail_password = "Tqc3ChgkmYWSmXqr"
            try:
                global randomPIN
                randomPIN = f"{random.randint(100,999)} {random.randint(100,999)}"
                sent_from = "MrSaintJCode@gmail.com"
                to = User_Email
                subject = "MrSAintJCode - Password Reset"
